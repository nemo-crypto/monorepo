...
/**
 * github: https://github.com/mumuy/browser
 */
...
export default function (userAgent) {
  ...
  if (window.chrome) {
    ...
    } else if (mime("type", "application/360softmgrplugin") || mime("type", "application/mozilla-npqihooquicklogin")) {
      is360 = true;
    } else if (chrome_vision > 36 && window.showModalDialog) {
      is360 = true;
  ...
  this.language = (function () {
    const g = (navigator.browserLanguage || navigator.language);
    const arr = g.split('-');
    if (arr[1]) {
  ...
  } else if (this.browser == 'Chrome' && parseInt(this.version) > 27) {
    this.engine = 'Blink';
